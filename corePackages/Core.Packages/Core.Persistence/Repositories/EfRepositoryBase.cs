    ...
    where TContext : DbContext
{
    ...
    protected void CheckHasEntityHaveOneToOneRelation(TEntity entity)
    {
        ...
        {
            throw new InvalidOperationException("Burada Foreign Key var O yüzden hata aldın");
        }
    }
    ...
    private async Task SetEntityAsDeletedAsync(IEnumerable<TEntity> entities,bool permament)
    {
        foreach (var entity in entities)
            await SetEntityAsDeletedAsync(entities, permament);
